...
local BabbleZone = AtlasLoot_GetLocaleLibBabble("LibBabble-Zone-3.0")
	...
	-- AtlasLoot_Data["TRIUMVIRATEMENU"], ["MPLUSMENU"], & ["TIER1SETS"] are declared here in order to load them on startup
	-- TODO: Find a better solution to the loading issues and move the tables to triumvirate.lua
