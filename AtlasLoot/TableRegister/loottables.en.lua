...
-------------------
	...
	AtlasLoot_TableNames["MPLUSMENUS2"] = { AL["Mythic+ Season 2 Menu"], "Menu"};
	AtlasLoot_TableNames["TIER1SETS"] = { AL["Tier 1"], "Menu" };
	AtlasLoot_TableNames["TIER2SETS"] = { AL["Tier 2"], "Menu" };
	...
	AtlasLoot_TableNames["MPLUSPLATES2"] = { AL["Mythic+ Season 2 Plate"], "AtlasLootTriumvirate"};
	AtlasLoot_TableNames["MPLUSMAILS2"] = { AL["Mythic+ Season 2 Mail"], "AtlasLootTriumvirate"};
	AtlasLoot_TableNames["MPLUSLEATHERS2"] = { AL["Mythic+ Season 2 Leather"], "AtlasLootTriumvirate"};
	AtlasLoot_TableNames["MPLUSCLOTHS2"] = { AL["Mythic+ Season 2 Cloth"], "AtlasLootTriumvirate"};
	AtlasLoot_TableNames["MPLUSMISCS2"] = { AL["Mythic+ Season 2 Misc"], "AtlasLootTriumvirate"};
	AtlasLoot_TableNames["MPLUSWEAPONSS2"] = { AL["Mythic+ Season 2 Weapons"], "AtlasLootTriumvirate"};
	AtlasLoot_TableNames["LEGENDARIES"] = { AL["Legendary Items"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["ARTEFACT1DEFAULT"] = { AL["Artefact Weapons +1"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["ARTEFACT2DEFAULT"] = { AL["Artefact Weapons +2"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["ARTEFACT3DEFAULT"] = { AL["Artefact Weapons +3 Default"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["ARTEFACT3RED"] = { AL["Artefact Weapons +3 Red"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["ARTEFACT3BLUE"] = { AL["Artefact Weapons +3 Blue"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["ARTEFACT4DEFAULT"] = { AL["Artefact Weapons +4 Default"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["ARTEFACT4RED"] = { AL["Artefact Weapons +4 Red"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["ARTEFACT4BLUE"] = { AL["Artefact Weapons +4 Blue"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["ARTEFACT5DEFAULT"] = { AL["Artefact Weapons +5 Default"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["ARTEFACT5RED"] = { AL["Artefact Weapons +5 Red"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["ARTEFACT5BLUE"] = { AL["Artefact Weapons +5 Blue"], "AtlasLootTriumvirate" };
	...
	AtlasLoot_TableNames["TIER1SETS_ROGUE"] = { AL["Tier 1 Rogue"], "AtlasLootTriumvirate"};
	AtlasLoot_TableNames["TIER1SETS_PRIEST"] = { AL["Tier 1 Priest"], "AtlasLootTriumvirate"};
	AtlasLoot_TableNames["TIER1SETS_SHAMAN"] = { AL["Tier 1 Shaman"], "AtlasLootTriumvirate"};
	AtlasLoot_TableNames["TIER1SETS_MAGE"] = { AL["Tier 1 Mage"], "AtlasLootTriumvirate"};
	...
	AtlasLoot_TableNames["TIER2SETS_DKDPS"] = { LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"].." - "..AL["DPS"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["TIER2SETS_DKTANK"] = { LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"].." - "..AL["Tanking"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["TIER2SETS_BALANCEDRUID"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"].." - "..AL["Balance"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["TIER2SETS_FERALDRUID"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"].." - "..AL["Feral"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["TIER2SETS_RESTODRUID"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"].." - "..AL["Restoration"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["TIER2SETS_HUNTER"] = { LOCALIZED_CLASS_NAMES_MALE["HUNTER"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["TIER2SETS_MAGE"] = { LOCALIZED_CLASS_NAMES_MALE["MAGE"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["TIER2SETS_HOLYPALA"] = { LOCALIZED_CLASS_NAMES_MALE["PALADIN"].." - "..AL["Holy"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["TIER2SETS_PROTPALA"] = { LOCALIZED_CLASS_NAMES_MALE["PALADIN"].." - "..AL["Protection"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["TIER2SETS_RETPALA"] = { LOCALIZED_CLASS_NAMES_MALE["PALADIN"].." - "..AL["Retribution"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["TIER2SETS_HOLYPRIEST"] = { LOCALIZED_CLASS_NAMES_MALE["PRIEST"].." - "..AL["Holy"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["TIER2SETS_SHADOWPRIEST"] = { LOCALIZED_CLASS_NAMES_MALE["PRIEST"].." - "..AL["Shadow"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["TIER2SETS_ROGUE"] = { LOCALIZED_CLASS_NAMES_MALE["ROGUE"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["TIER2SETS_ELESHAM"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"].." - "..AL["Elemental"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["TIER2SETS_ENHSHAM"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"].." - "..AL["Enhancement"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["TIER2SETS_RESTOSHAM"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"].." - "..AL["Restoration"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["TIER2SETS_WARLOCK"] = { LOCALIZED_CLASS_NAMES_MALE["WARLOCK"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["TIER2SETS_DPSWARR"] = { LOCALIZED_CLASS_NAMES_MALE["WARRIOR"].." - "..AL["Fury"], "AtlasLootTriumvirate" };
	AtlasLoot_TableNames["TIER2SETS_PROTWARR"] = { LOCALIZED_CLASS_NAMES_MALE["WARRIOR"].." - "..AL["Protection"], "AtlasLootTriumvirate" };
